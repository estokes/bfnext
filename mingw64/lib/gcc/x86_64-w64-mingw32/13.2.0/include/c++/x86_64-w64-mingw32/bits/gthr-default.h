...
#ifndef ATTRIBUTE__GLIBCXX_UNUSED
#define ATTRIBUTE__GLIBCXX_UNUSED __attribute__ ((__unused__))
#endif
...
int
__gthread_objc_condition_allocate (objc_condition_t condition ATTRIBUTE__GLIBCXX_UNUSED)
{
  /* Unimplemented.  */
  return -1;
}
...
int
__gthread_objc_condition_deallocate (objc_condition_t condition ATTRIBUTE__GLIBCXX_UNUSED)
{
  /* Unimplemented.  */
  return -1;
}
...
int
__gthread_objc_condition_wait (objc_condition_t condition ATTRIBUTE__GLIBCXX_UNUSED,
			       objc_mutex_t mutex ATTRIBUTE__GLIBCXX_UNUSED)
{
  /* Unimplemented.  */
  return -1;
}
...
int
__gthread_objc_condition_broadcast (objc_condition_t condition ATTRIBUTE__GLIBCXX_UNUSED)
{
  /* Unimplemented.  */
  return -1;
}
...
int
__gthread_objc_condition_signal (objc_condition_t condition ATTRIBUTE__GLIBCXX_UNUSED)
{
  /* Unimplemented.  */
  return -1;
}
