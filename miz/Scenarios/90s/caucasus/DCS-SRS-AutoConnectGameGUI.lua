...
SRSAuto.SERVER_SRS_HOST =
"135.181.77.146"                          -- overridden if SRS_HOST_AUTO is true -- set to your PUBLIC ipv4 address or domain srs.example.com
...
SRSAuto.SRS_NUDGE_PATH =
"C:\\Program Files\\DCS-SimpleRadio-Standalone\\clients-list.json" -- path to SERVER JSON EXPORT - enable Auto Export List on the server
...
SRSAuto.onPlayerConnect = function(id)
    ...
    if SRSAuto.SERVER_SEND_AUTO_CONNECT and id ~= HOST_PLAYER_ID then
        ...
        net.send_chat_to(
            string.format(SRSAuto.MESSAGE_PREFIX .. "%s", SRSAuto.SERVER_SRS_HOST .. ":" .. SRSAuto.SERVER_SRS_PORT), id)
    end
end
